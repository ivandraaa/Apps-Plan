...
import com.vann.planvann.database.DbContract
import com.vann.planvann.database.ReaderDbHelper
    ...
    private fun initListener() {
        btn_save.setOnClickListener {
            ...
            if (sTitle.isNullOrEmpty()) {
                ...
                et_desc.error = "Silahkan masukkan deskripsi"
